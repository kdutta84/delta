sap.ui.define(
  ...
  function (
    ...
    ("use strict");
    return Controller.extend("ns.deltaexcapp.controller.BaseController", {
      ...
      displayBusyDialog: function () {
        ...
        if (!this._BusyDialog) {
          this._BusyDialog = Fragment.load({
            id: oView.getId(),
            name: "ns.deltaexcapp.fragment.BusyDialog",
            controller: this,
          }).then(
            function (oDialog) {
      ...
      onAmountPopup: function () {
        ...
        if (!this._AmountDialog) {
          this._AmountDialog = Fragment.load({
            id: oView.getId(),
            name: "ns.deltaexcapp.fragment.Amount",
            controller: this,
          }).then(
            function (oDialog) {
              oView.addDependent(oDialog);
      ...
      onProfitTrailPopup: function (oEvent) {
        ...
        if (!this._ProfitTrailDialog) {
          this._ProfitTrailDialog = Fragment.load({
            id: oView.getId(),
            name: "ns.deltaexcapp.fragment.ProfitTrail",
            controller: this,
          }).then(
            function (oDialog) {
              oView.addDependent(oDialog);
      ...
      onLossTrailPopup: function (oEvent) {
        ...
        if (!this._LossTrailDialog) {
          this._LossTrailDialog = Fragment.load({
            id: oView.getId(),
            name: "ns.deltaexcapp.fragment.LossTrail",
            controller: this,
          }).then(
            function (oDialog) {
              oView.addDependent(oDialog);
      ...
      onOpenServer: function () {
        ...
        if (!this._ServerDialog) {
          this._ServerDialog = Fragment.load({
            id: oView.getId(),
            name: "ns.deltaexcapp.fragment.Server",
            controller: this,
          }).then(
            function (oDialog) {
              oView.addDependent(oDialog);
