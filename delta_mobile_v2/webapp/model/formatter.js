sap.ui.define(function () {
  ...
  var Formatter = {
    ...
    headerTitleEdit: function (HeaderLeft) {
      if (HeaderLeft == this.expiry) {
        return true;
      } else {
        return false;
      }
    },
    expirySpace: function (HeaderLeft) {
      if (HeaderLeft == this.expiry) {
        return false;
      } else {
        return true;
    ...
    //   }
    // },
    mobileDisplayChart: function (select) {
      if (select === this.chart || select === this.initApp) {
        return true;
      } else {
        return false;
      }
    },
    mobileDisplayOption: function (select) {
      if (select === this.option || select === this.initApp) {
        return true;
      } else {
        return false;
      }
    },
    mobileDisplayPnl: function (select) {
      if (select === this.pnl) {
        return true;
      } else {
        return false;
    ...
    mobileDisplayInput: function (select) {
      if (select === this.input) {
        return true;
      } else {
        return false;
      }
    },
    mobileDisplaySetting: function (select) {
      if (select === this.setting) {
        return true;
      } else {
        return false;
      }
    ...
    mobileDisplayHistory: function (select) {
      if (select === this.history) {
        return true;
      } else {
        return false;
      }
    ...
    mobileDisplayBook: function (select) {
      if (select === this.book) {
        return true;
      } else {
        return false;
    ...
    mobileDisplayAlert: function (select) {
      if (select === this.alert) {
        return true;
      } else {
        return false;
      }
    ...
    mobileDisplayMessage: function (select) {
      if (select === this.message) {
        return true;
      } else {
        return false;
      }
    },
    lockText: function (lockStatus) {
    ...
    lockStatus: function (lockStatus) {
      if (lockStatus === undefined) {
        return;
      }
      if (lockStatus === true) {
    ...
    headerTitle: function (headerType) {
      if (headerType === this.title) {
        return true;
      } else {
        return false;
      }
    },
    headerMessage: function (headerType) {
      if (headerType === this.message) {
        return true;
      } else {
        return false;
      }
    },
    headerZoom: function (headerType) {
      if (headerType === this.zoom) {
        return true;
      } else {
        return false;
      }
    },
    headerUpdate: function (headerType) {
      if (headerType === this.update) {
        return true;
      } else {
        return false;
      }
    },
    headerAskGap: function (headerType) {
      if (headerType === this.ask_gap) {
        return true;
      } else {
        return false;
      }
    },
    appIconColor: function (locked) {
      if (locked === true) {
        return "#4169E1";
      } else {
        return this.grey;
    ...
    summaryVisible: function (body) {
      if (body === this.summary) {
        return true;
      } else {
        return false;
      }
    },
    filterVisible: function (body) {
      if (body === this.filter) {
        return true;
      } else {
        return false;
