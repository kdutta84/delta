sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend("ns.deltaapphost.controller.History", {
      ...
      onHistFilter: function () {
        this.screen.body = this.filter;
        this.updateModel("ScreenModel", this.screen);
      },
      onHistSummary: function () {
        this.screen.body = this.summary;
        this.updateModel("ScreenModel", this.screen);
      },
      onHistTable: function () {
        this.screen.body = this.table;
        this.updateModel("ScreenModel", this.screen);
      },
      onHistItem: function () {
        this.screen.body = this.items;
        this.updateModel("ScreenModel", this.screen);
      },
      onNavBack: function () {
