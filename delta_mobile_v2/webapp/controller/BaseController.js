    ...
    return Controller.extend("ns.deltaapphost.controller.BaseController", {
      ...
      getServerTime: function () {
        ...
        if (gap > 0) {
          ...
          let upTime = this.convertSecondsForHistory(gap);
      ...
      onHeaderExpiry: function () {
        this.screen.mHeader = this.expiry;
        this.updateModel("ScreenModel", this.screen);
      },
      ...
      onChartZoom: function () {
        if (this.screen.mBody === this.chart) {
          if (this.zoomType === this.zoom1) {
            this.onZoomAll();
          } else {
            this.onZoom1();
          }
      ...
      onOpenLockPopup: function () {
        ...
        if (!this._SettingDialog) {
          this._SettingDialog = Fragment.load({
            id: oView.getId(),
            name: "ns.deltaapphost.fragment.Lock",
            controller: this,
          }).then(
            function (oDialog) {
              oView.addDependent(oDialog);
